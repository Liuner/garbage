...
/**
 * @ClassName NimbleExcel
 * @Description
 * @Author liugs
 * @Date 2023/8/2 0002 14:45
 */
public class NimbleExcel {

    static Map<String, String> dataFieldMap = new HashMap<>(16);
    // 有校验的列，用来后面做规则设置<sheetName,<列号，字段>>
    static Map<String, Map<Integer,String>> validateMap = new HashMap<>(16);

    public static void main(String[] args) throws IOException, InvalidFormatException {
        GarbageRspBaseBo retBo = new GarbageRspBaseBo();
        // 加载模板
        File templateFile = FileUtil.file("E:\\User\\windows\\Desktop\\fillDataTemplate.xlsx");
        ...
        // 有校验的列，用来后面做规则设置<sheetName,<列号，字段>>
        Map<String, Map<Integer, String>> validateMap = addHead(sheetList, fis);
    ...
    private static void setDateValidation(String filePath) throws IOException, InvalidFormatException {
    ...
    private static Map<String, Map<Integer, String>> addHead(List<GarbageSheetDataBo> sheetList, FileInputStream fis) throws IOException {
     ...
     */
    private static List<GarbageSheetDataBo> getColumnList() {
